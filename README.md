...
## compilation:
  ...
  * For Windows: open `sdl2_test/sdl2_test.cbp`, compile a `.cpp` and cross your fingers. If it works, dont touch anything except the editor, compile and execute. If its not working, go [here](https://www.guru99.com/install-linux.html)
